=== weiDocs - Knowledgebase and Documentation Plugin for WordPress ===
...
* [Documentation](https://weidocs.co/docs/weidocs/getting-started/?utm_source=wporg&utm_medium=readme&utm_campaign=docs)
* [Github](https://github.com/tareq1988/weidocs-plugin/)
...
weiDocs makes browsing and creating documentation a fresh and streamlined experience within the familiarity of your WP environment.

### Contribute ###
This may have bugs and lack of many features. If you want to contribute on this project, you are more than welcome. Please fork the repository from [Github](https://github.com/tareq1988/weidocs-plugin).
...
weiDocs uses [Appsero](https://appsero.com) SDK to collect some telemetry data upon user's confirmation. This helps us to troubleshoot problems faster & make product improvements.
 ...
 * **New:** Load CSS and JS files only for Docs. Fixes [#104](https://github.com/tareq1988/weidocs-plugin/issues/104)
 * **Fix:** Added missing textdomains. Fixes [#105](https://github.com/tareq1988/weidocs-plugin/issues/105)
 * **Fix:** Fix search API. Was breaking due to namespace issue with WP_Query. Fixes [#108](https://github.com/tareq1988/weidocs-plugin/issues/108)
 ...
 * **New:** Added new shortcode attribute (<code>items</code>) to limit no. of items shown. [#59](https://github.com/tareq1988/weidocs-plugin/pull/59/files)
 * **New:** Added a new filter <code>weidocs_email_feedback_to</code> for outgoing mail to address. [#63](https://github.com/tareq1988/weidocs-plugin/issues/63)
 ...
 * **Fix:** Bug with quotes in the doc title. [#66](https://github.com/tareq1988/weidocs-plugin/issues/66)
 ...
 * [improve] Added filter on weidocs post type
 ...
 * [new] Added filter <code>weidocs_breadcrumbs_html</code> to customize breadcrumb HTML
 * [new] Added `weidocs_get_publish_cap()` function for dynamic role binding on admin menu, pending post status support. #42

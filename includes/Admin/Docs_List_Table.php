...
class Docs_List_Table {
    ...
    public function add_meta_box() {
        add_meta_box( 'op-menu-meta-box-id', __( 'Helpfulness', 'weidocs' ), [ $this, 'helpfulness_metabox' ], 'docs', 'side', 'core' );
    }
    ...
    public function helpfulness_css() {
        ...
        <style type="text/css">
            .weidocs-positive { color: green; }
            .weidocs-negative { color: red; text-align: right; }
        </style>
        <?php
    }
    ...
    public function docs_list_columns_row( $column_name, $post_id ) {
        if ( 'votes' == $column_name ) {
            ...
            printf( '<span class="weidocs-positive">%d</span>/<span class="weidocs-negative">%d</span>', $positive, $negative );
        }
    }
